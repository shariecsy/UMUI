...
var pathToReactDOM = path.resolve(node_modules_dir,'react-dom/dist/react-dom.js');
...
var app_src_config = {
    ...
    plugins: [
        ...
        new CopyWepackPlugin([{
            from: pathToReact,
            to: path.resolve(__dirname, "dist")+'/libs/react.js',
        },{
            from: pathToReactDOM,
            to:path.resolve(__dirname, "dist")+'/libs/react-dom.js',
        }])
    ],
    externals:{
        'react':'React',
